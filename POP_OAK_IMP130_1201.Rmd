...
save(rf_training, file = "pop_trn_model_pip4.RData")
...
pip4_pred_OAK = data.frame("ID" = combine_OAK %>% select(ID), "ACTARM" = combine_OAK$ACTARM, "MOCHA" = factor(c("Desert", "Excluded", "Inflamed")[apply(pred, 1, which.max)], levels = c("Inflamed", "Excluded", "Desert")), "Manual" = combine_OAK$Final.call)
...
A_dat$combined = factor(c("Desert", "Excluded", "Inflamed")[apply(pred, 1, which.max)], levels = c("Inflamed", "Excluded", "Desert"))

pred <- predict(rf_training, 
                D_dat[, fea], 
                type = "prob")

D_dat$combined = factor(c("Desert", "Excluded", "Inflamed")[apply(pred, 1, which.max)], levels = c("Inflamed", "Excluded", "Desert"))
...
p_combined_A_OS = ggsurvplot(fit_combined, data = A_dat, palette = COLOR, size = 2, 
                ...
                risk.table = TRUE,  title = "OS for Atezolizumab by MOCHA-BITE", ggtheme=custom_theme(),
...
p_combined_A_OS$plot <- p_combined_A_OS$plot +
  ...
  annotate("text", size = 5, x = med_time[2], y = 0.8, label = round(med_time[2], 1), cex=4, col=COLOR[2], vjust=0, hjust = -0.2, fontface=1) + 
...
p_combined_D_OS = ggsurvplot(fit_combined, data = D_dat, palette = COLOR, size = 2, 
                             ...
                             conf.int = F,          # Add confidence interval
                             pval = FALSE,              # Add p-value
                             risk.table = TRUE,  title = "OS for Docetaxel by MOCHA-BITE", ggtheme=custom_theme(),
                             surv.median.line = "hv", tables.theme = theme_cleantable())
...
p_combined_A_PFS = ggsurvplot(fit_combined, data = A_dat, palette = COLOR, size = 2, 
                             ...
                             conf.int = F,          # Add confidence interval
                             pval = FALSE,              # Add p-value
                             risk.table = TRUE,  title = "PFS for Atezolizumab by MOCHA-BITE", ggtheme=custom_theme(),
                             surv.median.line = "hv", tables.theme = theme_cleantable())
...
p_combined_A_PFS$plot <- p_combined_A_PFS$plot +
  ...
  annotate("text", size = 5, x = med_time[2], y = 0.8, label = round(med_time[2], 1), cex=4, col=COLOR[2], vjust=0, hjust = 2, fontface=1) + 
...
p_combined_D_PFS = ggsurvplot(fit_combined, data = D_dat, palette = COLOR, size = 2, 
                             ...
                             conf.int = F,          # Add confidence interval
                             pval = FALSE,              # Add p-value
                             risk.table = TRUE,  title = "PFS for Docetaxel by MOCHA-BITE", ggtheme=custom_theme(),
                             surv.median.line = "hv", tables.theme = theme_cleantable())
...
png("OS_comp_new_preferred_OAK_pip4.png", width = 5000, height = 3800, res = 300)
...
png("PFS_comp_new_preferred_OAK_pip4.png", width = 5000, height = 3800, res = 300)
# Arrange multiple ggsurvplots and print the output
...
tmp1 = read.csv('20221002_IMP130_tracker_ANON.csv') %>% select(uni_id = hashed.uniId, HK_block = 'Specimen.._HK')
...
combine_IMP130 = combine_IMP130 %>% mutate(HK_block = substr(ID, 1, 9),
                                     combined = factor(c("Desert", "Excluded", "Inflamed")[apply(pred, 1, which.max)], levels = c("Inflamed", "Excluded", "Desert"))) %>% select(HK_block, Final.call, combined)

dat_IMP130 = merge(combine_IMP130, 
                   tmp3 %>% select(HK_block, os_months, os_cnsr, pfs_months, pfs_cnsr, arm), 
                   by = "HK_block")

pip4_pred_IMP130 = dat_IMP130 %>% select("ID" = HK_block, "Manual" = Final.call, "MOCHA" = combined, "ACTARM" = arm)  
```
...
p_comb_D_OS = ggsurvplot(fit_combined, data = D_dat, palette = COLOR, size = 2, 
                ...
                conf.int = F,          # Add confidence interval
                pval = FALSE,              # Add p-value
                risk.table = TRUE,  title = "OS for Placebo by MOCHA-BITE", ggtheme=custom_theme(),
                surv.median.line = "hv", tables.theme = theme_cleantable())
...
p_comb_D_OS$plot <- p_comb_D_OS$plot +
  ...
  annotate("text", size = 5, x = med_time[2], y = 0.6, label = round(med_time[2], 1), cex=4, col=COLOR[2], vjust=0, hjust = -1.5, fontface=1) + 
  annotate("text", size = 5, x = med_time[3], y = 0.6, label = round(med_time[3], 1), cex=4, col=COLOR[3], vjust=0, hjust = 0.5, fontface=1)
...
p_comb_D_pfs = ggsurvplot(fit_combined, data = D_dat, palette = COLOR, size = 2, 
                         ...
                         conf.int = F,          # Add confidence interval
                         pval = FALSE,              # Add p-value
                         risk.table = TRUE,  title = "PFS for Placebo by MOCHA-BITE", ggtheme=custom_theme(),
                         surv.median.line = "hv", tables.theme = theme_cleantable())
...
p_comb_D_pfs$plot <- p_comb_D_pfs$plot +
  ...
  annotate("text", size = 5, x = med_time[2], y = 0.6, label = round(med_time[2], 1), cex=4, col=COLOR[2], vjust=0, hjust = -2, fontface=1) + 
  annotate("text", size = 5, x = med_time[3], y = 0.6, label = round(med_time[3], 1), cex=4, col=COLOR[3], vjust=0, hjust = -0.5, fontface=1)
...
png("OS_comp_new_preferred_IMP130_pip4.png", width = 5000, height = 3800, res = 300)
# Arrange multiple ggsurvplots and print the output
arrange_ggsurvplots(list(splots[[1]], splots[[3]], splots[[2]], splots[[4]]), print = TRUE,
                    ncol = 2, nrow = 2, risk.table.height = 0.2)
dev.off()
...
png("PFS_comp_new_preferred_IMP130_pip4.png", width = 5000, height = 3800, res = 300)
# Arrange multiple ggsurvplots and print the output
arrange_ggsurvplots(list(splots[[5]], splots[[7]], splots[[6]], splots[[8]]), print = TRUE,
                    ncol = 2, nrow = 2, risk.table.height = 0.2)
dev.off()
...
write.csv(pip1_4_pred_OAK, 'pip1_4_pred_OAK.csv', row.names = F)


write.csv(pip1_4_pred_IMP130, 'pip1_4_pred_IMP130.csv', row.names = F)
...
hist_plot <-  function(this_dat = combine_POP) {
  ...
  this_fig = ggplot(this_dat) +
                geom_histogram(aes(x = CD8_density, fill = Immunophenotype),
                               position = "dodge", alpha = 1, bins = 10) +
...
png("Fig3.png", width = 4000, height = 4500, res = 300)
