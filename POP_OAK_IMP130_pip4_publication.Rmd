...
surv_plot <- function(fit_obj = fit_combined, data = A_dat, time = "OS_MONTHS", cen = "OS_CENSOR", method = "combined", title = "OS for Atezolizumab by \nMOCHA-BITE method", 
  ...
  p_combined_A_OS$table$theme$axis.text.y$size = 8.75
  ...
  p_combined_A_OS$plot <- p_combined_A_OS$plot +
    annotate("text", size = 3.25, x = 0.8*max(data[[time]]), y = 0.6, label = paste0("p=", p_val), cex=5, col="black", vjust=0, hjust = 1.1, fontface=1) + 
    annotate("text", size = 3.25, x = med_time[1], y = 0.8, label = round(med_time[1], 1), cex=5, col=COLOR[1], vjust=0, hjust = hjust1, fontface=1) + 
    annotate("text", size = 3.25, x = med_time[2], y = 0.8, label = round(med_time[2], 1), cex=5, col=COLOR[2], vjust=0, hjust = hjust2, fontface=1) + 
    annotate("text", size = 3.25, x = med_time[3], y = 0.8, label = round(med_time[3], 1), cex=5, col=COLOR[3], vjust=0, hjust = hjust3, fontface=1)
...
png('~/Automated_Immunophenotyping/JPATH/Fig1_C1.png', width = 1000, height = 1000, res = 300)
surv_plot(fit_obj = fit_manual, data = A_dat, time = "OS_MONTHS", cen = "OS_CENSOR", method = "Final.call", title = "OS for Atezolizumab by \nManual method", hjust1 = -1.5, hjust2 = -0.5, hjust3 = 0)
dev.off()
...
png('~/Automated_Immunophenotyping/JPATH/Fig1_C2.png', width = 1000, height = 1000, res = 300)
p_manual_A_OS
dev.off()
# p_manual_A_OS = ggsurvplot(fit_manual, data = A_dat, palette = COLOR, size = 2, 
#                 font.main = c(18, "bold"), legend.title = "Immunophenotyping", 
...
p_comb_D_OS = surv_plot(fit_obj = fit_combined, data = D_dat, time = "os_months", cen = "1-os_cnsr", method = "combined", title = "OS for Placebo by \nMOCHA-BITE method", 
                          hjust1 = 1.5, hjust2 = 0.5, hjust3 = -1.5)
